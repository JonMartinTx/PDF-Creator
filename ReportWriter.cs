...
#pragma warning restore CC0068 // Unused Method
		...
		private void PrintPage2(object sender, PrintPageEventArgs ev)
		{
			...
			using (var sr = new StreamReader("/home/tracym/workspace/Edsi/prtq/EPSR14378.txt"))
			{
					   ...
					   ((line = sr.ReadLine()) != null))
				{
					...
					{
						ev.Graphics.DrawString(blankLine, PrinterFont, Brushes.Black, leftMargin, yPos, stringFormat);
					}
					count++;
					}
